...
PRODUCT_PACKAGES += \
    ...
    DMServiceOverlayVendorKodiak \
    FrameworkResOverlayProductKodiak \
    FrameworkResOverlayVendorKodiak \
    PixelDisplayServiceOverlayProductKodiak \
    PixelNfcOverlayKodiak \
    PixelUwbOverlayMT5Spacecraft \
    PixelUwbOverlayRG5Malibu \
    PixelWifiOverlay2025Kodiak \
    SettingsKodiakOverlay \
    SystemUIGoogleOverlayVendorKodiak

PRODUCT_PACKAGES += \
    ApertureOverlayKodiak
...
# Recovery
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/recovery/init.recovery.device.rc:$(TARGET_COPY_OUT_RECOVERY)/root/init.recovery.kodiak.rc
